...
cur_date_formatted = cur_date[8:10] + '.' + cur_date[5:7] + '. ' + cur_date[11:19]

# Message
msg_line1 = 'Testing display'
msg_line2 = cur_date_formatted
...
LCD_LINE_1 = 0x80 	# Address: First Display Line
LCD_LINE_2 = 0xC0 	# Address: Second Display Line
LCD_CHR = GPIO.HIGH
LCD_CMD = GPIO.LOW
E_PULSE =  0.0005
E_DELAY =  0.0005
...
if __name__ == '__main__':
	...
	lcd_message(msg_line1)
	lcd_send_byte(LCD_LINE_2, LCD_CMD)
	lcd_message(msg_line2)
